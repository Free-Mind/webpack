...
var toogleTodo = exports.toogleTodo = function toogleTodo(id) {
    return {
        type: 'TOGGLE_TODO',
        id: id
    };
...
var _hashHistory2 = __webpack_require__(200);
...
var _AddTodo = __webpack_require__(138);

var _AddTodo2 = _interopRequireDefault(_AddTodo);

var _VisiableTodoList = __webpack_require__(140);

var _VisiableTodoList2 = _interopRequireDefault(_VisiableTodoList);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var App = function App() {
	return (//显示组件，只需要展示，不需要处理业务逻辑，省略connect
		_react2.default.createElement(
			'div',
			null,
			_react2.default.createElement(_AddTodo2.default, null),
			_react2.default.createElement(_VisiableTodoList2.default, null),
...
var _todos = __webpack_require__(144);

var _todos2 = _interopRequireDefault(_todos);

var _visibilityFilter = __webpack_require__(145);

var _visibilityFilter2 = _interopRequireDefault(_visibilityFilter);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var todoApp = (0, _redux.combineReducers)({ //利用combineReducers将多个字reducer组合在一起
...
var _salemgr = __webpack_require__(143);

var _salemgr2 = _interopRequireDefault(_salemgr);

var _salelistmgr = __webpack_require__(142);

var _salelistmgr2 = _interopRequireDefault(_salelistmgr);
...
exports.default = _react2.default.createElement(
    ...
    _react2.default.createElement(_reactRouter.Route, { path: '/salemgr', component: _salemgr2.default }),
    _react2.default.createElement(_reactRouter.Route, { path: '/salelistmgr', component: _salelistmgr2.default })
);
...
var _FilterLink = __webpack_require__(139);
...
var _Todo = __webpack_require__(136);
...
var _AddTodoForm = __webpack_require__(133);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		onSubmit: function onSubmit(text) {
			dispatch((0, _actions.addTodo)(text)); //创建一个action，并将这个action发射出去
		}
	};
}; /**
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		onTodoClick: function onTodoClick(id) {
			dispatch((0, _actions.toogleTodo)(id));
		}
	};
};
...
var Salelistmgr = function Salelistmgr() {
    return _react2.default.createElement(
        'div',
        null,
...
var Salemgr = function Salemgr() {
    return _react2.default.createElement(
        'div',
        null,
        'hello this is salemgr Page!'
    );
};

exports.default = Salemgr;
...
var _createTransitionManager2 = __webpack_require__(96);
...
var _PromiseUtils = __webpack_require__(91);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(73), __webpack_require__(269)(module)))
...
var store = (0, _redux.createStore)(_reducers2.default, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__()); //创建新的store
...
), document.getElementById('app')); //store通过provider传递给子组件
